...
public class TestListener implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		...
		//since we have used fail method at line 51 so no need of below line
	...
	public void onTestStart(ITestResult result) {
		...
		.assignCategory("Android").assignDevice("Ankitemulator").assignAuthor("Ankit Sharma");
